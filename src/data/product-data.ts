...
export const FiveoakHighlights = [
  {
    id: 1,
...
export const ReinnovaHighlights = [
  {
    id: 1,
...
export const ReinnovaCards = [
  {
    id: 2,
    icon: certificateIcon,
    content: "Certified engineering team to build APIs",
  },

  {
    ...
    icon: fintechIcon,
    content:
      "Managed services delivering to Retail Techs, Fintechs and startups",
  },
  {
    id: 1,
    icon: cloudIcon,
    content: "Cloud advisory services",
  },
  {
    id: 4,
    icon: global24Icon,
    content:
      "Global delivery team to support follow-the-sun model (24×7 support)",
  },
  {
    id: 5,
    icon: storeFrontIcon,
    content: "Storefront design development and implementation",
  },
];
