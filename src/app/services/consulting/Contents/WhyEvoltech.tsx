...
const WhyEvoltech = () => {
  return (
    <div className="md:p-20  lg:p-20 p-5 pb-15 lg:pt-0 flex items-center justify-center relative h-full bg-white">
      <div className="absolute top-0 -left-10 z-0 w-full h-full">
        <div>{leftRing}</div>
      </div>
      <div className="relative z-10 w-full flex items-center justify-center">
        <div className="w-full max-w-6xl md:px-6 flex flex-col items-center ">
