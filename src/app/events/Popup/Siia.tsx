...
const SiiaPopup = ({ event, onClose }: SiiaPopupProps) => {
  ...
  <div className="bg-white rounded-2xl shadow-lg max-w-2xl w-full mx-4 overflow-hidden relative">
    ...
    <div className="py-4 space-y-4 text-center mb-10">
      ...
      <p className="text-[#F47937] text-xl lg:text-2xl font-medium">October 12-14, 2024 | PHX</p>

      {/* --- Features Grid --- */}
      <div className="grid grid-cols-2 lg:grid-cols-4 bg-[#EDF3FE] border-y-1  p-6 px-16 w-full gap-6"
      style={{
    borderImageSource: "linear-gradient(90deg, rgba(5,42,70,0.5), #F47937 100%)",
    borderImageSlice: 1,
  }}>
