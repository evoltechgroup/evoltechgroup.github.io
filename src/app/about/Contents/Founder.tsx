  ...
  return (
    <div className="w-full h-full bg-[#F8F8F8] relative">
      ...
      <div className="relative z-2 grid grid-cols-4 sm:grid-cols-8 lg:grid-cols-12 grid-rows-1 gap-5 max-w-7xl mx-auto px-4 lg:px-0">
        <div className="relative col-span-4 md:col-span-8 lg:col-span-10 col-start-1 sm:col-start-2 lg:col-start-2 z-10 w-full flex gap-10 flex-col md:flex-row justify-between items-center h-full py-15 md:py-20">
          <div className="h-full flex flex-col w-full md:pb-5 gap-5 md:items-end items-center justify-start md:justify-between md:w-fit">
            ...
            <div className="flex flex-col w-full items-center justify-start">
              ...
              <Text
                className="font-medium w-full text-lg text-[#212121]"
                tag="p">
          ...
          <div className="flex flex-col items-start gap-3 md:gap-0 justify-center">
            ...
            <div className="flex flex-col text-black gap-5 max-w-xl">
              ...
              <Text className="text-base font-medium">
                Throughout his career, Thulasi has collaborated with banks,
                credit unions, startups, and Fortune 500 companies to scale
                technology platforms, craft go-to-market strategies for digital
                banking products—from consumer to commercial—and build
                high-performing global teams. He is widely recognized for his
                deep industry relationships and his ability to drive product-led
                growth, simplify complexity, and deliver innovation with
                measurable results.
              </Text>
              <Text className="text-base font-medium">
