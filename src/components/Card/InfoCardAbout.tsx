...
const InfoCardAbout: React.FC<CardProps> = ({ title, description }) => {
  return (
    <div className="border-l-1  border-[#FFBB00] px-4 h-[7rem] lg:h-[7rem] xl:h-[8rem] flex flex-col lg-w-[12rem] xl:w-[15rem] text-left w-full justify-center gap-4 md:gap-0 lg:justify-start xl:justify-between relative">
