...
const InfoCard: React.FC<CardProps> = ({ title, description }) => {
  return (
    <div className="rounded-3xl border border-[#768fb6a4] px-4 py-4 h-[7rem] md:h-[10rem] md:flex md:flex-col md:w-[15rem] text-left w-full md:justify-start relative">
